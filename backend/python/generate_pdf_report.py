...
# Logo path (auto-detected relative to script)
import os as _os
_SCRIPT_DIR = _os.path.dirname(_os.path.abspath(__file__))
LOGO_PATH = _os.path.join(_SCRIPT_DIR, "logo-small.png")
if not _os.path.exists(LOGO_PATH):
    LOGO_PATH = _os.path.join(_SCRIPT_DIR, "..", "storage", "assets", "logo-small.png")
